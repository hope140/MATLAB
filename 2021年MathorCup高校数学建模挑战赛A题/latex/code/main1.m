...
turn_end1 = [(A_x(4) + Int_A_B_x) / 2, (A_y(4) + Int_A_B_y) / 2];           
...
curR1 = sqrt((Int_2(1) - Int_1(1))^2 + (Int_2(2) - Int_1(2))^2) / 2;        
curR2 = sqrt((Int_3(1) - Int_1(1))^2 + (Int_3(2) - Int_1(2))^2) / 2;
curR3 = sqrt((Int_4(1) - Int_1(1))^2 + (Int_4(2) - Int_1(2))^2) / 2;

circle_center1 = [(Int_2(1) + Int_1(1)) / 2, (Int_2(2) + Int_1(2)) / 2];    
...
while i == 1
    ...
    elseif distance <= distance1 + distance2_1                              
        ...
        speed = 2;
        acc = 0;
    elseif distance <= distance1 + distance2_1 + distance3 + 5              
        curR = 0;
        speed = 2;
        acc = 0;
    else
